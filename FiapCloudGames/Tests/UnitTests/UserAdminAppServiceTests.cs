...
namespace FiapCloudGamesApi.Tests.UnitTests
{
    public class UserAdminAppServiceTests
    {
        ...
        {
            // Given
            var dto = new CreateUserDto { UserName = "user", Email = "user@email.com", Password = ValidPassword, Role = "user" };
        ...
        {
            // Given
            var dto = new CreateUserDto { UserName = "admin", Email = "admin@email.com", Password = ValidPassword, Role = "admin" };
        ...
        public async Task Given_UsersExist_When_GetUsers_Then_ReturnsUserDtos()
        {
            ...
            {
                new User("user1", new Email("a@a.com"), new Password(ValidPassword), UserType.CommonUser),
                new User("user2", new Email("b@b.com"), new Password(ValidPassword), UserType.Administrator)
            };
        ...
        {
            // Given
            var user = new User("user", new Email("a@a.com"), new Password(ValidPassword), UserType.CommonUser);
        ...
        {
            // Given
            var user = new User("user", new Email("a@a.com"), new Password(ValidPassword), UserType.Administrator);
            typeof(User).GetProperty("Id").SetValue(user, 1);
            _userRepositoryMock.Setup(x => x.GetByIdAsync(1)).ReturnsAsync(user);
